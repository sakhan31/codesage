...
def list_all_files(directory):
    """Use this tool to list all files in a given directory."""
    files = []
...
def list_all_directories(directory):
    """Use this tool to list all directories and subdirectories in a given directory."""
    directories = []
...
def read_file_content(filename):
    """For a given filename, Use this tool to read the content of the file"""
...
def load_graph() -> CompiledStateGraph:
    tools = [ list_all_files, list_all_directories,
         read_file_content, migrate_programming_lang_format, migrate_database_lang_format
         ]
